...
},{"./lib/Observable.js":"node_modules/zen-observable/lib/Observable.js"}],"src/reconciler.js":[function(require,module,exports) {
"use strict";
...
function updateDomProperties(dom, prevProps, nextProps) {
  ...
  Object.keys(nextProps).filter(isEvent).forEach(function (name) {
    ...
    if (!dom[name + '$']) {
      // note - bug if handler mutates
      var stream = fromEvent(dom, eventType);
...
},{"./element":"src/element.js","zen-observable":"node_modules/zen-observable/index.js"}],"src/didact.js":[function(require,module,exports) {
"use strict";
